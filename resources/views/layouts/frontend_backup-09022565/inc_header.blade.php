...
<link rel="stylesheet" href="{{ asset('frontend/css/modal.css' ) }}" type="text/css" />
<link rel="stylesheet" href="{{ asset('frontend/css/default.css' ) }}" type="text/css" />
<link rel="stylesheet" href="{{ asset('frontend/css/default+en.css' ) }}" type="text/css" />
<link rel="stylesheet" href="{{ asset('frontend/css/slick-theme.css' ) }}" type="text/css" />
