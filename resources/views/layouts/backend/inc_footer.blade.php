...
<script src="{{ asset('backend/assets/vendor/jquery-ui/js/jquery-ui-1.10.4.custom.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/jquery-ui-touch-punch/jquery.ui.touch-punch.js') }}"></script>
...
<script src="{{ asset('backend/assets/vendor/jquery-easypiechart/jquery.easypiechart.js') }}"></script>
...
<script src="{{ asset('backend/assets/vendor/ios7-switch/ios7-switch.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/summernote/summernote.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/bootstrap-maxlength/bootstrap-maxlength.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/jquery-maskedinput/jquery.maskedinput.js') }}"></script>
...
<script src="{{ asset('backend/assets/vendor/bootstrap-timepicker/js/bootstrap-timepicker.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/fuelux/js/spinner.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/dropzone/dropzone.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/bootstrap-markdown/js/markdown.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/bootstrap-markdown/js/to-markdown.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/bootstrap-markdown/js/bootstrap-markdown.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/codemirror/lib/codemirror.js') }}"></script>

<script src="{{ asset('backend/assets/vendor/codemirror/addon/selection/active-line.js') }}"></script>
		
<script src="{{ asset('backend/assets/vendor/codemirror/addon/edit/matchbrackets.js') }}"></script>
		
<script src="{{ asset('backend/assets/vendor/codemirror/mode/javascript/javascript.js') }}"></script>
		
<script src="{{ asset('backend/assets/vendor/codemirror/mode/xml/xml.js') }}"></script>
		
<script src="{{ asset('backend/assets/vendor/codemirror/mode/htmlmixed/htmlmixed.js') }}"></script>
		
<script src="{{ asset('backend/assets/vendor/codemirror/mode/css/css.js') }}"></script>
...
<script src="{{ asset('backend/assets/javascripts/dashboard/examples.dashboard.js') }}"></script>
...
<script src="{{ asset('backend/assets/javascripts/forms/examples.advanced.form.js') }}"></script>