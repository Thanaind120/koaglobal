                                ...
                                <header class="panel-heading bg-primary">
                                    ...
                                    <div class="widget-profile-info">
                                        <div class="profile-picture">
                                            <img src="{{ asset('backend/assets/images/!logged-user.jpg') }}">
                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="checkbox-custom checkbox-default">
                                                            <input type="checkbox" checked="" id="todoListItem1"
                                                                class="todo-check">
                                                            <label class="todo-label" for="todoListItem1"><span>Lorem
                                                                    ipsum dolor sit
                                                                    amet</span></label>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="checkbox-custom checkbox-default">
                                                            <input type="checkbox" id="todoListItem2"
                                                                class="todo-check">
                                                            <label class="todo-label" for="todoListItem2"><span>Lorem
                                                                    ipsum dolor sit
                                                                    amet</span></label>
                                                        </div>
                                                        <div class="todo-actions">
                                                    ...
                                                    <li>
                                                        <div class="checkbox-custom checkbox-default">
                                                            <input type="checkbox" id="todoListItem3"
                                                                class="todo-check">
                                                            <label class="todo-label" for="todoListItem3"><span>Lorem
                                                                    ipsum dolor sit
                                                                    amet</span></label>
                                                        </div>
                                                        <div class="todo-actions">
                                                    ...
                                                    <li>
                                                        <div class="checkbox-custom checkbox-default">
                                                            <input type="checkbox" id="todoListItem4"
                                                                class="todo-check">
                                                            <label class="todo-label" for="todoListItem4"><span>Lorem
                                                                    ipsum dolor sit
                                                                    amet</span></label>
                                                        </div>
                                                        <div class="todo-actions">
                                                    ...
                                                    <li>
                                                        <div class="checkbox-custom checkbox-default">
                                                            <input type="checkbox" id="todoListItem5"
                                                                class="todo-check">
                                                            <label class="todo-label" for="todoListItem5"><span>Lorem
                                                                    ipsum dolor sit
                                                                    amet</span></label>
                                                        </div>
                                                        <div class="todo-actions">
                                                    ...
                                                    <li>
                                                        <div class="checkbox-custom checkbox-default">
                                                            <input type="checkbox" id="todoListItem6"
                                                                class="todo-check">
                                                            <label class="todo-label" for="todoListItem6"><span>Lorem
                                                                    ipsum dolor sit
                                                                    amet</span></label>
                                                        </div>
                                                        <div class="todo-actions">
                                        ...
                                        <div id="collapse1Two" class="accordion-body collapse">
                                            <div class="panel-body">
                                                <ul class="simple-user-list mb-xlg">
                                                    ...
                                                    <li>
                                                        <figure class="image rounded">
                                                            <img src="{{ asset('backend/assets/images/!sample-user.jpg') }}" alt="Joe Junior"
                                                                class="img-circle">
                                                        </figure>
                        ...
                        <div class="panel-body">
                            ...
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <script type="text/javascript">
                                        var sparklineLineDashData = [15, 16, 17, 19, 10, 15, 13, 12, 12, 14, 16,
                                            17
                                        ];
                        ...
                        <div class="panel-body">
                            <div class="content">
                                <ul class="simple-user-list">
                                    <li>
                                        <figure class="image rounded">
                                            <img src="{{ asset('backend/assets/images/!sample-user.jpg') }}" alt="Joseph Doe Junior"
                                                class="img-circle">
                                        </figure>
                                        <span class="title">Joseph Doe Junior</span>
                                    ...
                                    <li>
                                        <figure class="image rounded">
                                            <img src="{{ asset('backend/assets/images/!sample-user.jpg') }}" alt="Joseph Junior"
                                                class="img-circle">
                                        </figure>
                                        <span class="title">Joseph Junior</span>
                                        <span class="message truncate">Lorem ipsum dolor sit.</span>
                                                ...
                                                <div class="thumbnail-gallery">
                                                    <a class="img-thumbnail lightbox"
                                                        ...
                                                        <img class="img-responsive" width="215"
                                                            src="{{ asset('backend/assets/images/projects/project-4.jpg') }}">
                                                        <span class="zoom">
                                ...
                                <table class="table table-striped mb-none">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div
                                                    class="progress progress-sm progress-half-rounded m-none mt-xs light">
