<div class="top-header clearfix">
    <div class="container">
        <div class="row">
            <div class="top-header-wrap row l-header">
                ...
                <div class="info col-md-8 ">
                    <div>
                        <ul class="l-extraNav l-extraNavB">
                            <li class="l-region">
                                <a class="is-openRegion" href="#">Select Your Region</a>
                            </li>
                                            ...
                                            <div class="gsc-results-wrapper-overlay">
                                                ...
                                                <div class="gsc-positioningWrapper">
                                                    <div class="gsc-tabsAreaInvisible">
                                                        <div aria-label="refinement" role="tab"
                                                            class="gsc-tabHeader gsc-inline-block gsc-tabhActive">
                                                            Custom Search</div><span class="gs-spacer">
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="gsc-positioningWrapper">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="gsc-orderby-container">
                                                                    <div class="gsc-orderby-invisible">
                                                                        <div
                                                                            class="gsc-orderby-label gsc-inline-block">
                                                                            Sort by:</div>
                                                                        <div
                                                ...
                                                <div class="gsc-wrapper">
                                                    ...
                                                    <div class="gsc-resultsbox-invisible">
                                                        <div
                                                            class="gsc-resultsRoot gsc-tabData gsc-tabdActive">
                                                            <div>
